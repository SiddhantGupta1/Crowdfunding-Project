  ...
  return (
    <div className='text-center bg-white text-gray-800 py-24 px-6'>
      ...
      <div className='flex justify-center items-center space-x-2'>
        ...
        border-green-600 text-green-600 font-medium text-xs leading-tight 
          uppercase rounded-full shadow-md bg-transparent hover:bg-green-700 hover:text-white'>
          Donate
        </button>
      </div>
      ...
      <div className="flex justify-center items-center mt-10">
        ...
        <div className="flex flex-col justify-center items-center h-20 border shadow-md w-full">
          <span className='text-lg font-bold text-green-800 leading-5 '>{stats?.totalProjects || 0}</span>
          <span>Posts</span>
        </div>
        ...
        <div className="flex flex-col justify-center items-center h-20 border shadow-md w-full">
          <span className='text-lg font-bold text-green-800 leading-5 '>{stats?.totalDonations || 0} ETH</span>
          <span>Donated</span>
        </div>
