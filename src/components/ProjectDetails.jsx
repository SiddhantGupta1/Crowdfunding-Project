  ...
  return (
    <div className='py-24 px-6 flex justify-center'>
        <div className='flex justify-center items-center flex-col md:w-2/3'>
            <div className='flex justify-start items-start w-full sm:space-x-5 flex-wrap'>
                ...
                <div className='flex-1 sm:py-0 py-4'>
                    ...
                    <div className='flex justify-between items-center w-full pt-1'>
                        <div className='flex justify-start space-x-2'>
                            ...
                            <small className='text-gray-500 font-bold'>{project?.backers} Donor{project?.backers == 1 ? '' : 's'}</small>
                        </div>
                    ...
                    <div>
                        ...
                        <div className='flex justify-between w-full items-center font-bold mt-2'>
